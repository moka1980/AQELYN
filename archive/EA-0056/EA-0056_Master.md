...
|---|---|
| Project | AQELYN |
| Engineering Archive | EA-0056 |
| Implementation Specification | IS-039 |
| Title | AQELYN Vulnerability Intelligence Engine |
| Domain | Exposure Platform |
...
- **EA-0056-FR-001:** The platform shall support vulnerability intelligence.
- **EA-0056-FR-002:** The platform shall support cve enrichment.
- **EA-0056-FR-003:** The platform shall support exploitability context.
- **EA-0056-FR-004:** The platform shall support patch guidance.
- **EA-0056-FR-005:** The platform shall support asset risk correlation.
- **EA-0056-FR-006:** The platform shall support threat intelligence integration.
- **EA-0056-FR-007:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0056-FR-008:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0056-FR-009:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0056-FR-010:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0056-FR-011:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0056-FR-012:** The platform shall provide traceable, evidence-backed operation for this capability.
...
- `VulnerabilityIntelligenceEngineDiscovered`
- `VulnerabilityIntelligenceEngineUpdated`
- `VulnerabilityIntelligenceEngineAssessed`
- `VulnerabilityIntelligenceEngineFindingCreated`
- `VulnerabilityIntelligenceEngineEvidenceLinked`
- `VulnerabilityIntelligenceEngineRecommendationCreated`
- `VulnerabilityIntelligenceEngineWorkflowRequested`
- `VulnerabilityIntelligenceEnginePolicyViolationDetected`
- `VulnerabilityIntelligenceEngineStatusChanged`
- `VulnerabilityIntelligenceEngineArchived`
...
| Operation | Purpose |
|---|---|
| `create` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `read` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `list` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `search` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `assess` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `explain` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `recommend` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `export` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
| `archive` | Provides controlled access to aqelyn vulnerability intelligence engine functions. |
...
|---|---|---|
| EA-0056-FR-001 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-002 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-003 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-004 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-005 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-006 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-007 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-008 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-009 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-010 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-011 | Mandatory | Unit, integration, and acceptance tests |
| EA-0056-FR-012 | Mandatory | Unit, integration, and acceptance tests |
...
|---|---|---|---|
| EA-0056-FR-001 | Connector | Automated verification | Test report and evidence record |
| EA-0056-FR-002 | Normalizer | Automated verification | Test report and evidence record |
| EA-0056-FR-003 | Repository | Automated verification | Test report and evidence record |
| EA-0056-FR-004 | Evidence Linker | Automated verification | Test report and evidence record |
| EA-0056-FR-005 | Policy Adapter | Automated verification | Test report and evidence record |
| EA-0056-FR-006 | AI Explanation | Automated verification | Test report and evidence record |
| EA-0056-FR-007 | Workflow | Automated verification | Test report and evidence record |
| EA-0056-FR-008 | Event Publisher | Automated verification | Test report and evidence record |
| EA-0056-FR-009 | Dashboard | Automated verification | Test report and evidence record |
| EA-0056-FR-010 | Audit Exporter | Automated verification | Test report and evidence record |
| EA-0056-FR-011 | Security Controls | Automated verification | Test report and evidence record |
| EA-0056-FR-012 | Operational Monitoring | Automated verification | Test report and evidence record |
