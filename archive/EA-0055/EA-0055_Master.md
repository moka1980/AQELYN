...
|---|---|
| Project | AQELYN |
| Engineering Archive | EA-0055 |
| Implementation Specification | IS-038 |
| Title | AQELYN Attack Surface Discovery Engine |
| Domain | Exposure Platform |
...
- **EA-0055-FR-001:** The platform shall support attack surface discovery.
- **EA-0055-FR-002:** The platform shall support external exposure mapping.
- **EA-0055-FR-003:** The platform shall support cloud and internet-facing inventory.
- **EA-0055-FR-004:** The platform shall support asset ownership enrichment.
- **EA-0055-FR-005:** The platform shall support continuous discovery and drift detection.
- **EA-0055-FR-006:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-007:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-008:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-009:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-010:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-011:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0055-FR-012:** The platform shall provide traceable, evidence-backed operation for this capability.
...
- `AttackSurfaceDiscoveryEngineDiscovered`
- `AttackSurfaceDiscoveryEngineUpdated`
- `AttackSurfaceDiscoveryEngineAssessed`
- `AttackSurfaceDiscoveryEngineFindingCreated`
- `AttackSurfaceDiscoveryEngineEvidenceLinked`
- `AttackSurfaceDiscoveryEngineRecommendationCreated`
- `AttackSurfaceDiscoveryEngineWorkflowRequested`
- `AttackSurfaceDiscoveryEnginePolicyViolationDetected`
- `AttackSurfaceDiscoveryEngineStatusChanged`
- `AttackSurfaceDiscoveryEngineArchived`
...
| Operation | Purpose |
|---|---|
| `create` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `read` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `list` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `search` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `assess` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `explain` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `recommend` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `export` | Provides controlled access to aqelyn attack surface discovery engine functions. |
| `archive` | Provides controlled access to aqelyn attack surface discovery engine functions. |
...
|---|---|---|
| EA-0055-FR-001 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-002 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-003 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-004 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-005 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-006 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-007 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-008 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-009 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-010 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-011 | Mandatory | Unit, integration, and acceptance tests |
| EA-0055-FR-012 | Mandatory | Unit, integration, and acceptance tests |
...
|---|---|---|---|
| EA-0055-FR-001 | Connector | Automated verification | Test report and evidence record |
| EA-0055-FR-002 | Normalizer | Automated verification | Test report and evidence record |
| EA-0055-FR-003 | Repository | Automated verification | Test report and evidence record |
| EA-0055-FR-004 | Evidence Linker | Automated verification | Test report and evidence record |
| EA-0055-FR-005 | Policy Adapter | Automated verification | Test report and evidence record |
| EA-0055-FR-006 | AI Explanation | Automated verification | Test report and evidence record |
| EA-0055-FR-007 | Workflow | Automated verification | Test report and evidence record |
| EA-0055-FR-008 | Event Publisher | Automated verification | Test report and evidence record |
| EA-0055-FR-009 | Dashboard | Automated verification | Test report and evidence record |
| EA-0055-FR-010 | Audit Exporter | Automated verification | Test report and evidence record |
| EA-0055-FR-011 | Security Controls | Automated verification | Test report and evidence record |
| EA-0055-FR-012 | Operational Monitoring | Automated verification | Test report and evidence record |
