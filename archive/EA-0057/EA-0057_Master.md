# EA-0057 - AQELYN Asset Discovery & Inventory Engine
...
|---|---|
| Project | AQELYN |
| Engineering Archive | EA-0057 |
| Implementation Specification | IS-040 |
| Title | AQELYN Asset Discovery & Inventory Engine |
| Domain | Asset Platform |
...
- **EA-0057-FR-001:** The platform shall support asset discovery and inventory.
- **EA-0057-FR-002:** The platform shall support device, identity, service, cloud, endpoint, web, api, certificate, and software asset normalization.
- **EA-0057-FR-003:** The platform shall support lifecycle state.
- **EA-0057-FR-004:** The platform shall support ownership.
- **EA-0057-FR-005:** The platform shall support knowledge graph publication.
- **EA-0057-FR-006:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-007:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-008:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-009:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-010:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-011:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0057-FR-012:** The platform shall provide traceable, evidence-backed operation for this capability.
...
- `AssetDiscovery&InventoryEngineDiscovered`
- `AssetDiscovery&InventoryEngineUpdated`
- `AssetDiscovery&InventoryEngineAssessed`
- `AssetDiscovery&InventoryEngineFindingCreated`
- `AssetDiscovery&InventoryEngineEvidenceLinked`
- `AssetDiscovery&InventoryEngineRecommendationCreated`
- `AssetDiscovery&InventoryEngineWorkflowRequested`
- `AssetDiscovery&InventoryEnginePolicyViolationDetected`
- `AssetDiscovery&InventoryEngineStatusChanged`
- `AssetDiscovery&InventoryEngineArchived`
...
| Operation | Purpose |
|---|---|
| `create` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `read` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `list` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `search` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `assess` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `explain` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `recommend` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `export` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
| `archive` | Provides controlled access to aqelyn asset discovery & inventory engine functions. |
...
|---|---|---|
| EA-0057-FR-001 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-002 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-003 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-004 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-005 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-006 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-007 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-008 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-009 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-010 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-011 | Mandatory | Unit, integration, and acceptance tests |
| EA-0057-FR-012 | Mandatory | Unit, integration, and acceptance tests |
...
|---|---|---|---|
| EA-0057-FR-001 | Connector | Automated verification | Test report and evidence record |
| EA-0057-FR-002 | Normalizer | Automated verification | Test report and evidence record |
| EA-0057-FR-003 | Repository | Automated verification | Test report and evidence record |
| EA-0057-FR-004 | Evidence Linker | Automated verification | Test report and evidence record |
| EA-0057-FR-005 | Policy Adapter | Automated verification | Test report and evidence record |
| EA-0057-FR-006 | AI Explanation | Automated verification | Test report and evidence record |
| EA-0057-FR-007 | Workflow | Automated verification | Test report and evidence record |
| EA-0057-FR-008 | Event Publisher | Automated verification | Test report and evidence record |
| EA-0057-FR-009 | Dashboard | Automated verification | Test report and evidence record |
| EA-0057-FR-010 | Audit Exporter | Automated verification | Test report and evidence record |
| EA-0057-FR-011 | Security Controls | Automated verification | Test report and evidence record |
| EA-0057-FR-012 | Operational Monitoring | Automated verification | Test report and evidence record |
