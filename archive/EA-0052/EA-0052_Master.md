...
|---|---|
| Project | AQELYN |
| Engineering Archive | EA-0052 |
| Implementation Specification | IS-035 |
| Title | AQELYN Endpoint Intelligence Engine |
| Domain | Endpoint Platform |
...
- **EA-0052-FR-001:** The platform shall support endpoint telemetry inventory.
- **EA-0052-FR-002:** The platform shall support process, service, software, account, certificate, browser, network, firewall, device, and runtime visibility.
- **EA-0052-FR-003:** The platform shall support local privacy mode.
- **EA-0052-FR-004:** The platform shall support cross-platform agent integration.
- **EA-0052-FR-005:** The platform shall support evidence-backed endpoint facts.
- **EA-0052-FR-006:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-007:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-008:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-009:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-010:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-011:** The platform shall provide traceable, evidence-backed operation for this capability.
- **EA-0052-FR-012:** The platform shall provide traceable, evidence-backed operation for this capability.
...
- `EndpointIntelligenceEngineDiscovered`
- `EndpointIntelligenceEngineUpdated`
- `EndpointIntelligenceEngineAssessed`
- `EndpointIntelligenceEngineFindingCreated`
- `EndpointIntelligenceEngineEvidenceLinked`
- `EndpointIntelligenceEngineRecommendationCreated`
- `EndpointIntelligenceEngineWorkflowRequested`
- `EndpointIntelligenceEnginePolicyViolationDetected`
- `EndpointIntelligenceEngineStatusChanged`
- `EndpointIntelligenceEngineArchived`
...
| Operation | Purpose |
|---|---|
| `create` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `read` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `list` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `search` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `assess` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `explain` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `recommend` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `export` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
| `archive` | Provides controlled access to aqelyn endpoint intelligence engine functions. |
...
|---|---|---|
| EA-0052-FR-001 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-002 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-003 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-004 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-005 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-006 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-007 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-008 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-009 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-010 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-011 | Mandatory | Unit, integration, and acceptance tests |
| EA-0052-FR-012 | Mandatory | Unit, integration, and acceptance tests |
...
|---|---|---|---|
| EA-0052-FR-001 | Connector | Automated verification | Test report and evidence record |
| EA-0052-FR-002 | Normalizer | Automated verification | Test report and evidence record |
| EA-0052-FR-003 | Repository | Automated verification | Test report and evidence record |
| EA-0052-FR-004 | Evidence Linker | Automated verification | Test report and evidence record |
| EA-0052-FR-005 | Policy Adapter | Automated verification | Test report and evidence record |
| EA-0052-FR-006 | AI Explanation | Automated verification | Test report and evidence record |
| EA-0052-FR-007 | Workflow | Automated verification | Test report and evidence record |
| EA-0052-FR-008 | Event Publisher | Automated verification | Test report and evidence record |
| EA-0052-FR-009 | Dashboard | Automated verification | Test report and evidence record |
| EA-0052-FR-010 | Audit Exporter | Automated verification | Test report and evidence record |
| EA-0052-FR-011 | Security Controls | Automated verification | Test report and evidence record |
| EA-0052-FR-012 | Operational Monitoring | Automated verification | Test report and evidence record |
