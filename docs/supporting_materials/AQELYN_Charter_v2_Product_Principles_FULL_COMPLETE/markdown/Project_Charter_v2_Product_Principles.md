...
This Charter update establishes mandatory product and user-experience principles for AQELYN.

AQELYN shall not only detect security problems; it shall make security understandable, explainable, evidence-based, and actionable for users ranging from home users to enterprise security professionals.
...
AQELYN shall provide an intelligent Cyber Security Operating Environment that enables users of all experience levels to understand, evaluate, and improve their security posture through evidence-driven analysis, understandable explanations, and practical remediation guidance.
...
- What happened.
- Why it matters.
- How AQELYN determined the finding.
...
AQELYN shall never generate recommendations based solely on assumptions.
...
The objective of AQELYN is to help people improve security, not to overwhelm them with technical information.
...
AQELYN shall clearly communicate:
...
AQELYN shall avoid alarmist messaging.
...
Every component of AQELYN shall be deterministic where possible, evidence-driven, traceable, auditable, reproducible, and explainable.
...
AQELYN findings shall be rendered using a consistent pattern:
...
When implementing AQELYN, Codex should treat findings as structured, typed objects.
...
This document is approved as a AQELYN Charter v2.0 amendment and shall be included in the pre-coding baseline.
