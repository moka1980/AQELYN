...
| [EA-0008 Workflow Engine](EA-0008-workflow-engine.spec.md) | EA-0008 | EA-0004, Finding, EA-0001 | [C-005](C-005_Task_Bundle.md) | Accepted (see ECR-0056) |
...
| [EA-0033 Identity Security Posture Management](EA-0033-identity-security-posture.spec.md) | EA-0033 | **EA-0011**, EA-0013, EA-0007, EA-0006, EA-0020, EA-0012, EA-0025, EA-0023 | [C-030](C-030_Task_Bundle.md) | Accepted (ECR-0049–0052, ECR-0074) |
...
| **P-002 — annotate escalation** | *(P track)* | *ECR-0084 shape 1; one consumer, dormant until persistence* | [P-002](P-002_Task_Bundle.md) | Accepted |
| **Surface v1 — local operator UI** | *(P track)* | *real kernel reads; loopback-only; no writes, auth, persistence or events* | [ECR-0088](ECR-LOG.md) | Accepted |
| **Surface widening — first four owner read seams** | *(P track)* | *ISPM, exposure, secrets and supply chain; one runtime-backed reporting path* | [ECR-0089](ECR-0089_SURFACE_WIDENING.md) | Accepted |
...
| **Single-column ordering witnesses, part 2** | *(cross-cutting tests)* | *ECR-0096 deferred batch; four cursor walks plus workflow prefixes; residual census scheduled as ECR-0098* | [ECR-0097](ECR-0097_INTERIOR_KEYSETS.md) | Accepted |
| **Residual ordered reads, part 1** | *(cross-cutting tests)* | *sixteen cursorless bounded lists; classification preceded thirty-two two-store cases* | [ECR-0098](ECR-0098_RESIDUAL_READS.md) | Accepted |
| **Leading-key witnesses and arc closure** | *(cross-cutting tests)* | *fixture symmetry; every tuple component decides a comparison; carried-matrix policy recorded* | [ECR-0099](ECR-0099_LEADING_KEYS.md) | Accepted |
...
| **Progressive disclosure** | *(P track)* | *the Charter's six levels as data; a mode narrows, never softens* | [ECR-0104](ECR-0104_PROGRESSIVE_DISCLOSURE.md) | Accepted |
...
| [Self-verification disclosures](SELF_VERIFICATION_DISCLOSURES.md) | *(cross-cutting)* | *C-034–C-038 hand-back for Codex's retroactive pass* | *(none)* | Live index |
| [First-deployment items](FIRST_DEPLOYMENT_ITEMS.md) | *(cross-cutting)* | *not backlog — questions only a real deployment can settle* | *(none)* | Live index |
