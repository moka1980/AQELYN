...
| **Residual ordered reads, part 1** | *(cross-cutting tests)* | *sixteen cursorless bounded lists; classification precedes thirty-two witnesses* | [ECR-0098](ECR-0098_RESIDUAL_READS.md) | Proposed |
